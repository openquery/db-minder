package CommandArbitrator;
# This class runs on the command line node, to manage communications with the Arbitrator nodes.
# There will be an instance of this class for each Arbitrator.
